...
//		leftUpper = 270f + binocularFOV / 2f;
//		leftLower = 270f - binocularFOV / 2f;
//		rightUpper = 90f - binocularFOV / 2f;
//		rightLower = 90f + binocularFOV / 2f;
...
//			angleFraction = angleDelta/((180f-binocularFOV)/2f);
//		}
//		// Too far left
...
//		}
		...
		//currIPD = OVRManager.profile.ipd;
		//currIPD = currIPD * angleFraction;
		//hmdLeftEye.position = (hmdLeftEye.position - centerEyeAnchor.localPosition)*angleFraction + centerEyeAnchor.localPosition;
		//hmdRightEye.position = (hmdRightEye.position - centerEyeAnchor.localPosition)*angleFraction + centerEyeAnchor.localPosition;
	
		//Display center rotation
//		hmdOrientText.text = "x: " + centerEyeAnchor.localRotation.eulerAngles.x + "\n" + 
//			"y: " + centerEyeAnchor.localRotation.eulerAngles.y + "\n" + 
//				"z: " + centerEyeAnchor.localRotation.eulerAngles.z + "\n"
//				+ "LeftEye: " + hmdLeftEye.position + "\n" 
//				+ "RightEye: " + hmdRightEye.position;
		...
		// Print out distance between eyes (TL 2-2016)
		
		//float distance = (leftEyeAnchor.position - rightEyeAnchor.position).magnitude;
		//print (distance);
