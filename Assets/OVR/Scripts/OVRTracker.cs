...
public class OVRTracker
{
	...
	public bool isEnabled
	{
		...
		get {
			...
			// TLian: Added this so isEnabled is set to false when usePositionTracking is false. 
			// I'm not sure if haing isEnabled false actually effects anything else though. 
